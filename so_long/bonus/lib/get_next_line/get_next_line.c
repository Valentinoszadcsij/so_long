...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/09 03:16:40 by voszadcs          #+#    #+#             */
/*   Updated: 2023/01/17 21:10:54 by voszadcs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	output_line = get_output_line(buffer);
	temp = buffer;
	buffer = remaining_buffer(&buffer[ft_strlen(output_line)]);
	free(temp);
